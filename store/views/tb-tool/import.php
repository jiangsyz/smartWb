    ...
    <div class="row">
        <div class="col-lg-12">
            <div style="text-align:left;">
                <a class="btn btn-success" href="#" role="button" id="import" data-toggle="modal" data-target="#myModal3">导入淘宝待发货订单</a>
                    ...
                    <div class="modal-content animated flipInY">
                        ...
                        <div class="modal-body">
                            <?php $form = ActiveForm::begin(['id'=>'my-awesome-dropzone', 
                                'action' => Yii::$app->urlManager->createUrl(['tb-tool/import']),
                                'method' => "post",
                                'options'=>[
                            ...
                            <?= $form->field($order, 'otype')->label('订单类型')->dropDownlist(['1'=>'子订单', '2'=>'主订单']) ?>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <?php $form = ActiveForm::begin(['id'=>'export-dropzone', 
                                        ...
                                        <?= $form->field($logistics, 'id')->label('物流渠道')->dropDownlist([
                                            '1' => '顺丰冷运',
                                            '2' => '顺丰快递',
                                            '3' => '德邦快递',
                                            '4' => '德邦红酒',
