    ...
    <div class="row">
        <div class="col-lg-12">
            <div style="text-align:left;">
                <a class="btn btn-success" href="#" role="button" id="import" data-toggle="modal" data-target="#myModal3">导入手机号</a>
            </div>
                         ...
                         <!--   --><?php /*ActiveForm::end(); */?>
                            ...
                            <script type="text/javascript">
                                Dropzone.options.zsExcel = {
                                    url: "<?php echo Yii::$app->urlManager->createUrl(['tool/sms']);?>",//文件提交地址
                                    method:"post",  //也可用put
